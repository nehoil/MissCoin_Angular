...
export class ContactService {
  ...
  //mock the server
  private _contacts$ = new BehaviorSubject<Contact[]>(CONTACTS);
  ...
  public query(filterBy = { term: '' }) {
      ...
      .subscribe((contacts) => this._contacts$.next(contacts));
  ...
  private _updateContact(contact: Contact) {
    const contacts = this._contacts$
      .getValue()
      .map((c) => (contact._id === c._id ? contact : c));
